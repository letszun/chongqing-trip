const CACHE='cq-trip-v5-colorful';
const ASSETS=['./','./index.html','./spots.html','./eat.html','./money.html','./talk.html','./check.html','./detail.html','./styles.css','./data.js','./app.js','./manifest.json'];
